...
exports.nuevoPedido = async (req, res, next) =>
{
    ...
    {
        await pedido.save();
        res.json({mensaje: 'Se agregó el pedido exitosamente'});
    }   
    catch (error) 
    {
        console.log(error);
...
exports.actualizarPedido = async (req, res, next) =>
{
    try 
    {
        let pedido = await Pedidos.findOneAndUpdate({_id: req.params.idPedido}, req.body, {new:true}).populate('cliente').populate({path: 'pedido.producto', model: 'Productos'});
...
exports.eliminarPedido = async (req, res, next) =>
{
    try 
    {
        ...
        res.json({mensaje: 'El peido se eliminó correctamente'});
    } 
    catch (error) 
    {
        console.log(error);
